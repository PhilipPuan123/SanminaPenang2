...
namespace RVISMMC
{
    public class RVISML
    {
        ...
        public List<RoboticInspectionSystem> ListinspectionData =  new List<RoboticInspectionSystem>(); //List for all 33 parametric data //change to 32 *latest
        ...
        public void ResultDataProcces(object sender, string parameter)
        {
            ...
            if (match_checkpoint.Success)
            {
                ...
                if (measurementNameCounter >= 0 && measurementNameCounter < 32)
                {
